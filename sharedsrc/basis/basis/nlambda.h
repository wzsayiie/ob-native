...
nfunc(char     *, NPassArgU8Chars , (NPass *pass, int index));
nfunc(char16_t *, NPassArgU16Chars, (NPass *pass, int index));
nfunc(char32_t *, NPassArgU32Chars, (NPass *pass, int index));
...
nfunc(char     *, NLambdaCallU8Chars , (NLambda *lambda));
nfunc(char16_t *, NLambdaCallU16Chars, (NLambda *lambda));
nfunc(char32_t *, NLambdaCallU32Chars, (NLambda *lambda));
