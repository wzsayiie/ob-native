...
nclink NIterator *__NArrayRange (__NArray *self);
...
nfunc(NIterator *, NArrayRange , (NArray *self));
...
nfunc(NIterator *, NIntArrayRange , (NIntArray *self));
...
nfunc(NIterator *, NFltArrayRange , (NFltArray *self));
