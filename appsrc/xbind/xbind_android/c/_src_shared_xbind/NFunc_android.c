...
Java_src_shared_xbind_NFunc_findFunc(JNIEnv *env, jclass cls,
    jstring name)
{
    int fPos = 0;
    if (name) {
...
JNIEXPORT jint JNICALL
Java_src_shared_xbind_NFunc_funcRetType(JNIEnv *env, jclass cls,
    jint fPos)
{
...
Java_src_shared_xbind_NFunc_funcRetRetained(JNIEnv *env, jclass cls,
    jint fPos)
{
...
Java_src_shared_xbind_NFunc_callFunc(JNIEnv *env, jclass cls,
    jint  fPos , jint  argc ,
    ...
    jlong word0, jlong word1, jlong word2, jlong word3)
{
    ...
    int64_t words[] = {word0, word1, word2, word3};
